      ...
      <section className="mt-20 mb-20 flex items-center justify-center">
        ...
        <section className="mt-20 mb-20">
          <p className="dark:text-neutral-200 text-xl xl:text-left text-center">
            I am French and I have lived in the UK for 30 years, 25 of which have been spent teaching. I find it 
            very rewarding to take each of my students on their individual learning journeys and watch them become confident
            in all the facets of the language. 
            <br />
            <br />
            I am very patient and encouraging and it is important to me that my students feel at ease. I always suggest a 
            free, informal introductory meeting before we start. Just tap on the "Free Call" button to navigate to my bookings 
            page.
          </p>
          <Link href="/booking">
